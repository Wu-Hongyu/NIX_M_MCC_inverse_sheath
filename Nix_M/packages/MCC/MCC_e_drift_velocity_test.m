...
function tests = MCC_e_drift_velocity_test
% test filename
...
%     collision_energy_count=zeros(1,1);
    ...
    for ti=1:simulation.all_timesteps%主循环
        ...
        if colli_result.happen==1
            ...
            position_e(colli_result.att_index,:)=[];
...
hold off
save ./packages/MCC/MCCdrift_velocity_testResults.mat Td_list drift_velocity ref_v;
end
